...
async fn main(spawner: Spawner) -> ! {
    ...
    let config = embassy_net::Config::ipv4_static(embassy_net::StaticConfigV4 {
        address: embassy_net::Ipv4Cidr::new(Ipv4Address::new(192, 168, 10, 2), 24),
        gateway: Some(Ipv4Address::new(192, 168, 10, 1)),
    ...
    loop {
        ...
        let remote_endpoint = (Ipv4Address::new(192, 168, 10, 1), 8000);
        info!("connecting...");
